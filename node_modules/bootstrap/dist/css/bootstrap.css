...
.form-control:focus {
  ...
  border-color: #9bb1fa;
  outline: 0;
  box-shadow: 0 0 0 0.25rem rgba(0, 68, 255, 0.25);
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.25rem rgba(0, 68, 255, 0.25);
}
...
.valid-tooltip {
  ...
  font-size: 0.875rem;
  color: #fff;
  background-color: rgba(0, 183, 121, 0.9);
  border-radius: 1rem;
}
...
.form-control.is-valid:focus {
  border-color: #00b779;
  box-shadow: 0 0 0 0.25rem rgba(0, 183, 121, 0.25);
}
...
.form-select.is-valid:not([multiple])[size="1"] {
  ...
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23343a40' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e"),
    url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2300b779' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.btn-primary {
  ...
  --bs-btn-disabled-bg: #0044ff;
  --bs-btn-disabled-border-color: #0044ff;
}
.btn-secondary {
  --bs-btn-color: #fff;
  --bs-btn-bg: #e33cd1;
...
.btn-outline-primary {
  ...
  --bs-btn-border-color: #0044ff;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #0044ff;
  --bs-btn-hover-border-color: #0044ff;
  --bs-btn-focus-shadow-rgb: 0, 68, 255;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #0044ff;
  --bs-btn-active-border-color: #0044ff;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #0044ff;
...
.dropdown-menu {
  ...
  --bs-dropdown-box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15);
  --bs-dropdown-link-color: #2d2d2d;
  --bs-dropdown-link-hover-color: #292929;
  --bs-dropdown-link-hover-bg: #e9ecef;
  --bs-dropdown-link-active-color: #fff;
  --bs-dropdown-link-active-bg: #0044ff;
...
.nav-pills {
  ...
  --bs-nav-pills-link-active-bg: #0044ff;
}
.nav-pills .nav-link {
  background: none;
  border: 0;
...
.accordion {
  ...
  --bs-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(0, 68, 255, 0.25);
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(0, 68, 255, 0.25);
  --bs-pagination-active-color: #fff;
  --bs-pagination-active-bg: #0044ff;
  --bs-pagination-active-border-color: #0044ff;
...
.list-group {
  ...
  --bs-list-group-active-bg: #0044ff;
  --bs-list-group-active-border-color: #0044ff;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
...
.toast {
  ...
  --bs-toast-box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15);
...
.modal {
  ...
  --bs-modal-box-shadow: 0 0.125rem 0.25rem rgba(0, 68, 255, 0.075);
...
@media (min-width: 576px) {
  .modal {
    ...
    --bs-modal-box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15);
  }
  .modal-dialog {
...
.popover {
  ...
  --bs-popover-box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15);
...
.offcanvas-sm {
  ...
  --bs-offcanvas-box-shadow: 0 0.125rem 0.25rem rgba(0, 68, 255, 0.075);
}
@media (max-width: 575.98px) {
  .offcanvas-sm {
    position: fixed;
...
.text-bg-primary {
  color: #fff !important;
  background-color: RGBA(0, 68, 255, var(--bs-bg-opacity, 1)) !important;
}
.text-bg-secondary {
  color: #fff !important;
...
.shadow {
  box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15) !important;
}
.shadow-sm {
  box-shadow: 0 0.125rem 0.25rem rgba(0, 68, 255, 0.075) !important;
}
.shadow-lg {
  box-shadow: 0 1rem 3rem rgba(0, 68, 255, 0.175) !important;
}
.shadow-none {
...
#mainNav.navbar-dark .navbar-nav > li.nav-item > a.nav-link:focus {
  color: #fff;
}
@media (min-width: 992px) {
  #mainNav {
...
.reflow-product-list.ref-cards .ref-product .ref-excerpt,
.reflow-product-list.ref-cards .ref-product .ref-price {
  color: #4e5d78;
}
.reflow-product-list.ref-cards .ref-product .ref-name,
.reflow-product-list.ref-cards .ref-product .ref-price {
  font-weight: bold;
}
.reflow-product-list.ref-cards .ref-product .ref-image {
  box-shadow: 0 0.5rem 1rem rgba(0, 68, 255, 0.15);
}
.ref-button {
  font-weight: 700;
  text-decoration: none !important;
...
.ref-button.ref-button-success:hover,
.ref-button.ref-button-success:active {
  color: #fff;
